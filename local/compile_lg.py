...
def compile_LG(lang_dir: str, lm_dir: str) -> k2.Fsa:
    """
    Args:
      lang_dir:
    ...
    #ptFile = lang_dir +'/G_3_gram.pt'
    ptFile = os.path.join( lm_dir, 'G_3_gram.pt')
    txtFile = os.path.join( lm_dir, 'G_3_gram.fst.txt')
    #txtFile = lang_dir +'/G_3_gram.fst.txt' 
    if Path(ptFile).is_file():
