...
def get_parser():
    ...
    parser.add_argument(
         ...
         type=str,
         default='cuts',
         help='Name of the cut set file (exluding .jsonl.gz)'
     )
...
def main():
    ...
    if not params.use_averaged_model:
        ...
        if params.iter > 0:
            ...
            print(f"start value before assertion: {start}")
    ...
    test_cuts = dataset.test_cuts(args.cut_set_name)
    ...
    save_results(
        params=params,
        test_set_name=args.cut_set_name,
